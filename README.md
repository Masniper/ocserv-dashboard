...
- **Custom Telegram copy & bot metadata:** see [docs/telegram-translations.md](docs/telegram-translations.md) for `TELEGRAM_I18N_PATH` (API messages) and `TELEGRAM_BOT_METADATA_LOCALES_PATH` (BotFather descriptions).
